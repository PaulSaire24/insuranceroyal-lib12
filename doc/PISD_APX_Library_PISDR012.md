...
#### 2.31 Método 31: executeGetRolesByProductAndModality(BigDecimal productId, String modalityType)
...
#### 2.32 Método 32: executeGetRequiredFieldsForCreatedInsrcEvnt(String policyQuotaInternalId)
...
#### 2.33 Método 33: executeInsertSingleRow(String queryId, Map<String, Object> arguments, String... requiredParameters)
...
#### 2.34 Método 34: executeGetASingleRow(String queryId, Map<String, Object> arguments)
